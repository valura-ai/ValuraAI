...
const Features = () => {
  return (
    <section className="bg-[rgba(219,246,255,1)] flex mt-[-155px] flex-col overflow-hidden items-center text-base text-[rgba(69,71,69,1)] font-normal tracking-[-0.25px] pt-[219px] pb-5 px-[8%] rounded-[32px_32px_0px_0px] max-md:max-w-full max-md:pt-[100px] max-md:px-5">
      <div className="flex w-[100%] max-w-full items-stretch gap-[40px_100px] ml-[11px]">
        <div className="grow my-auto whitespace-nowrap">Trusted By:</div>
        <img
      ...
      <div className="self-center w-full max-w-[1341px] mt-11 max-md:max-w-full max-md:mt-10">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
          ...
          <div className="w-[33%] max-md:w-full max-md:ml-0">
            <div className="bg-[rgba(0,10,20,1)] h-[456px] overflow-hidden text-white w-full rounded-[25px] max-md:max-w-full max-md:mt-[29px]">
          ...
          <div className="w-[33%] ml-5 max-md:w-full max-md:ml-0">
            <div className="bg-[rgba(0,10,20,1)] h-[456px] overflow-hidden text-white w-full rounded-[25px] max-md:max-w-full max-md:mt-[29px]">
              <div className="flex flex-col items-stretch pb-[33px] rounded-[25px] border-[rgba(255,255,255,0.1)] border-solid border-2 max-md:max-w-full">
                <div className="flex flex-col relative min-h-[374px] w-full text-[32px] font-[350] leading-[0.9] pt-[200px] pb-[13px] px-[25px] max-md:max-w-full max-md:pt-[100px] max-md:px-5">
                  <img
                  ...
                  <div className="relative text-[19px] font-semibold leading-[1.2] ml-[33px] mb-14 mr-[34px] rounded-[18px] max-md:mx-2.5">
                  ...
                  <h3 className="relative min-h-[29px] w-[100%] max-w-full">
                    AI Portfolio Analysis
                  </h3>

                  <p className="relative text-xl font-normal leading-none mt-[13px]">
                    You&apos;ll definitely like this template, so why not
