...
const Hero = () => {
  return (
    <section className="flex flex-col relative z-10 min-h-screen w-full items-center justify-center pt-20 pb-12 px-4 max-md:pt-16 max-md:pb-8 overflow-hidden">
      {/* Navigation Tabs */}
      <div className="relative mt-4 z-10 flex w-[25%] max-w-full items-stretch text-sm whitespace-nowrap text-center leading-none justify-between mb-5 max-md:w-[320px] max-md:gap-2">
        {[
          { label: "Reliable" },
          { label: "Adaptable" },
          { label: "Swift" },
          ...
          <div
            key={index}
            className="bg-[rgba(0,0,0,0.25)] backdrop-blur-sm border flex gap-2 pt-2 pb-2 px-4 rounded-full border-[rgba(34,197,94,0.5)] border-solid"
          >
      ...
      <h2 className="relative z-10 text-white text-5xl lg:text-6xl font-light leading-tight text-center max-md:text-4xl font-['Junicode'] lowercase">
        reliable way to
      </h2>
      <h3 className="relative z-10 text-white text-5xl lg:text-6xl font-light leading-tight text-center max-md:text-4xl font-['Junicode'] italic lowercase">
        smart finance
      </h3>

      {/* Action Buttons */}
      <div className="relative z-10 flex items-center gap-4 mt-6 max-md:flex-col max-md:w-full max-md:px-4">
      ...
      {/* Description */}
      <p className="relative z-10 text-white text-lg font-normal leading-relaxed text-center mt-6 max-w-xl max-md:text-base">
        Experience seamless financial control with Valura
        <br />
        built for security, simplicity, and your peace of mind.
      </p>

      {/* Stats */}
      <div className="relative z-10 flex w-full max-w-md justify-between items-center gap-8 mt-10 max-md:gap-6">
        <div className="flex items-center gap-3">
          <img
            ...
            alt="Assets"
            className="w-10 h-10 rounded-lg border-solid border border-green-300"
          />
        ...
        <div className="flex items-center gap-3">
          <img
            ...
            alt="Users"
            className="w-10 h-10 rounded-lg border border-solid border-green-300"
          />
          <div className="text-left">
